...
`mint-model-cog` consumes, one deployment-descriptor model cog per served
model:
...
def main(argv=None):
    ap = argparse.ArgumentParser(
        ...
        description="LLMModel CRs -> mint-model-cog catalog YAML")
    ...
    header = ("# Generated by scripts/llmmodel_catalog.py from LLMModel "
              "CRs.\n# Feed to: pixi run mint-model-cog -- --config "
